...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    isAuthenticated: {
      ...
      set: function set(value) {
        this.$store.isAuthenticated = value;
      }
    }
  },
  ...
  methods: {
    login: function login() {
      this.$refs.username.validateForm();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "text-input",
  props: ["value", "minLength", "required"],
  data: function data() {
    return {
      validated: false
    };
...
var render = function () {
  ...
  return _c("div", { staticClass: "login-container" }, [
    _c(
      ...
      [
        _c("h2", { staticClass: "login-form__header" }, [_vm._v("Đăng nhập")]),
        _vm._v(" "),
        _c("text-input", {
          ref: "username",
          attrs: { required: "true" },
        ...
        _vm._v(" "),
        _c("button", { staticClass: "login-form__button" }, [
          _vm._v("\n      Đăng nhập\n    "),
        ]),
        _vm._v(" "),
        _c(
          "router-link",
          { staticClass: "login-form__link", attrs: { to: "/signup" } },
          [_vm._v("\n      Chưa có tài khoản?\n    ")]
        ),
      ],
      1
...
var render = function () {
  ...
  return _c("div", { staticClass: "input-wrapper" }, [
    _c("input", {
      ...
      class: { input__invalid: _vm.errorMessage },
      attrs: { type: "text" },
